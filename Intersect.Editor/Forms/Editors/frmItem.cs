...
namespace Intersect.Editor.Forms.Editors
{
    ...
    public partial class FrmItem : EditorForm
    {
        ...
        {
            mEditorItem.StatsGiven[6] = (int)darkNumericUpDown2.Value;
        }

        private void darkNumericUpDown4_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[5] = (int)darkNumericUpDown4.Value;
        }

        private void darkNumericUpDown3_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[5] = (int)darkNumericUpDown3.Value;
        }

        private void darkNumericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[6] = (int)darkNumericUpDown1.Value;
        }

        private void darkNumericUpDown6_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[7] = (int)darkNumericUpDown6.Value;
        }

        private void darkNumericUpDown8_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[8] = (int)darkNumericUpDown8.Value;
        }

        private void darkNumericUpDown10_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[9] = (int)darkNumericUpDown10.Value;
        }

        private void darkNumericUpDown18_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[10] = (int)darkNumericUpDown18.Value;
        }

        private void darkNumericUpDown16_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[11] = (int)darkNumericUpDown16.Value;
        }

        private void darkNumericUpDown14_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[12] = (int)darkNumericUpDown14.Value;
        }

        private void darkNumericUpDown12_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.StatsGiven[13] = (int)darkNumericUpDown12.Value;
        }

        private void darkNumericUpDown9_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[9] = (int)darkNumericUpDown9.Value;
        }

        private void darkNumericUpDown5_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[7] = (int)darkNumericUpDown5.Value;
        }

        private void darkNumericUpDown7_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[8] = (int)darkNumericUpDown7.Value;
        }

        private void darkNumericUpDown17_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[10] = (int)darkNumericUpDown17.Value;
        }

        private void darkNumericUpDown15_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[11] = (int)darkNumericUpDown15.Value;
        }

        private void darkNumericUpDown13_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[12] = (int)darkNumericUpDown13.Value;
        }

        private void darkNumericUpDown11_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PercentageStatsGiven[13] = (int)darkNumericUpDown11.Value;
        }
    }
